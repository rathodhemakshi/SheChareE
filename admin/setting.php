...
$ret=mysqli_query($con,"SELECT `id` FROM `login` WHERE `id`='$uid' and `password`='$currentpassword'");
$num=mysqli_num_rows($ret);
if($num>0)
{
$query=mysqli_query($con,"UPDATE `login` set `password`='$newpassword' WHERE `id`='$uid'");
...
<head>
    <title>SPMS||Change Password</title>
